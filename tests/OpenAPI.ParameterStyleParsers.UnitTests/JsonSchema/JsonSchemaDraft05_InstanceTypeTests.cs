...
namespace OpenAPI.ParameterStyleParsers.UnitTests.JsonSchema;

public class JsonSchemaDraft05_InstanceTypeTests
{
    [Theory]
        ...
        string schemaAsJson)
    {
        ...
        var schema = new JsonSchemaDraft05(jsonSchemaNode);
    ...
    public static readonly TheoryData<InstanceType?, string, string> InstanceTypes = new()
    {
        ...
        // OpenAPI 3.0 nullable extension tests
        {
        ...
        {
            InstanceType.Integer | InstanceType.Null,
            "#",
            """
            {
                "type": "integer",
        ...
        {
            InstanceType.Number | InstanceType.Null,
            "#",
            """
            {
                "type": "number",
        ...
        {
            InstanceType.Boolean | InstanceType.Null,
            "#",
            """
            {
                "type": "boolean",
        ...
        {
            InstanceType.Array | InstanceType.Null,
            "#",
            """
            {
                "type": "array",
        ...
        {
            InstanceType.Object | InstanceType.Null,
            "#",
            """
            {
                "type": "object",
        ...
        // nullable: false should not add Null type
        {
            InstanceType.String,
            "#",
            """
        ...
        // nullable on null type is redundant but should still work
        {
            InstanceType.Null,
            "#",
            """
