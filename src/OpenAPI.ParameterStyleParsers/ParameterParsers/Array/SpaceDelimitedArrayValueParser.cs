...
internal sealed class SpaceDelimitedArrayValueParser : ArrayValueParser
{
    public SpaceDelimitedArrayValueParser(bool explode, JsonSchema schema) : base(schema, explode)
    {
    }
