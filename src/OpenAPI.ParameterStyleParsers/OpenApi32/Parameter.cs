...
namespace OpenAPI.ParameterStyleParsers.OpenApi32;
...
#pragma warning disable CS1591
        ...
        internal static readonly string[] All = [Matrix, Label, Simple, Form, SpaceDelimited, PipeDelimited, DeepObject, Cookie];
...
#pragma warning disable CS1591
        ...
        internal static readonly string[] All = [Path, Header, Query, Cookie, QueryString];
#pragma warning restore CS1591
    }
    ...
    public static readonly Dictionary<string, string[]> LocationToStylesMap = new()
    {
        ...
        [Locations.Cookie] = [Styles.Form, Styles.Cookie],
    };
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    /// <summary>
    /// Parses an OpenAPI 3.2 parameter
    /// </summary>
    ...
    /// <summary>
    /// Create a parameter from an OpenAPI 3.2 parameter specification
    /// <see href="https://spec.openapis.org/oas/v3.2.0#parameter-object"/>
    /// </summary>
    ...
    public static Parameter FromOpenApi32ParameterSpecification(string parameterSpecificationAsJson)
    {
        ...
        return FromOpenApi32ParameterSpecification(json);
    }
